																																																																			...
																																																																			**Diretrizes de Formato:**
																																																																			...
																																																																			2. **Corpo (Bullet Points):** Cada ponto deve seguir a estrutura:
																																																																			    - **Conteúdo**: *Ação:* O que foi alterado; *Intencionalidade:* Por que essa alteração foi necessária e qual problema de negócio ou técnico ela resolve. *Impacto:* O que muda no comportamento esperado do sistema.
																																																																			    - **Formato**: Cada bullet deve ser um único parágrafo fluido, sem subtítulos como "Ação", "Intencionalidade" ou "Impacto"
